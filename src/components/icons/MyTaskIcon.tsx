...
export default function MyTaskIcon({ className, px, color }: IconProps) {
  return (
    <svg
      width={px}
      height={px}
    ...
    >
      ...
      <path d="M11 13.586L9.20697 11.793L7.79297 13.207L11 16.414L16.207 11.207L14.793 9.79303L11 13.586Z" />
    </svg>
  );
}
